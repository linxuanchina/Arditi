...
public sealed class ApplicationModule : Module
{
    ...
    protected override void Load(ContainerBuilder builder)
    {
        ...
        builder.Register(context => new RequestSender(new MediatR.Mediator(context.Resolve<MediatR.ServiceFactory>())))
        ...
        foreach (var pipelineBehavior in new[] { typeof(ApplicationPipelineBehavior<,>) })
        {
        ...
        foreach (var handler in new[]
                 {
                     typeof(IRequestHandler<,>), typeof(IMessageHandler<>), typeof(IRequestMessageFactory<,>)
                 })
        {
