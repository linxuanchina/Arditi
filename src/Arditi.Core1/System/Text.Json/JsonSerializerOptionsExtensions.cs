...
public static class JsonSerializerOptionsExtensions
{
    ...
    public static JsonSerializerOptions AddResponsiveExceptionConverter(this JsonSerializerOptions options)
    {
        options.Converters.Add(new ResponsiveExceptionConverter());
        return options;
    }
}
